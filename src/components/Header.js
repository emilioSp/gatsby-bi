        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="it-header-slim-wrapper-content px-2">
                <a
                  href="//www.governo.it/"
                  target="_blank"
                  rel="noreferrer"
                  className="navbar-brand font-weight-semibold"
                >
                  Governo Italiano
                </a>
              </div>
            ...
            <div className="row">
              <div className="it-header-center-content-wrapper px-2 px-sm-0">
                ...
                <div className="it-right-zone">
                  <div className="it-socials d-none d-md-flex text-nowrap">
                  ...
                  <div className="it-search-wrapper">
                    <span className="d-none d-md-block font-weight-semibold">Cerca</span>
                    <a href="/cerca" className="search-link rounded-icon" aria-label="Cerca">
              ...
              <nav aria-label="Menu principale" className="navbar navbar-expand-lg has-megamenu theme-dark-mobile">
                ...
                <div className="navbar-collapsable" id="nav02" style={{ display: 'none', zIndex: 2000 }}>
                  ...
                  <div className="menu-wrapper">
                    <div className="pl-4 pt-4 d-lg-none">
                    ...
                    <ul className="navbar-nav">
                      ...
                      <li className="nav-item">
                        <Link to="/dashboard/" className="nav-link font-weight-semibold">
                          Dashboard
                        </Link>{' '}
                      </li>
                      <li className="nav-item">
                        <Link to="/dipartimento/" className="nav-link font-weight-semibold">
                          Dipartimento
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/optimized_image/" className="nav-link font-weight-semibold">
                          Ottimizzazione immagini
                        </Link>
                      </li>
                      <li className="nav-item">
                        <Link to="/json_data/" className="nav-link font-weight-semibold">
                          Dati elaborati da formato json
                        </Link>
                      </li>
                    </ul>
                    <div className="it-socials d-flex text-nowrap ml-4 pt-4 d-lg-none">
                      <span className="text-white">Seguici su</span>
                      <div className="ml-3">
                        <div className="d-flex align-items-center">
                          <a
                            href="https://twitter.com/InnovazioneGov"
