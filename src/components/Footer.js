        ...
        <div className="row clearfix">
          <div className="col-sm-12">
            <div className="it-brand-wrapper">
              <a href="/" className="flex-wrap flex-md-nowrap justify-content-center justify-content-md-start">
                <img
                  src="https://innovazione.gov.it/images/logo-repubblica-italiana-56a773ac.svg"
                  alt="Logo Repubblica Italiana"
                  className="icon"
                />
                <img
                  src="https://innovazione.gov.it/images/logo-mid-white-6d6c98f9.svg"
            ...
            <div className="col-md-6 col-xl-3 mb-3">
              ...
              <div className="mb-2">
                <div className="text-center text-md-left">
                  <svg
                    aria-label="Sede istituzionale"
                    className="mb-3 align-top icon icon-sm icon-white"
                    focusable="false"
                    role="img"
                  >
                  ...
                  <div className="link-list-wrapper">
                    <ul className="link-list">
                      <li>
                        <a
                          href="https://goo.gl/maps/V7vcjUCHqafhGChj8"
                          className="list-item font-weight-semibold"
                          target="_blank"
                          rel="noreferrer"
                        >
                ...
                <div className="text-center text-md-left">
                  ...
                  <div className="link-list-wrapper">
                    <ul className="link-list">
                      ...
                      <li>
                        <a
                          href="mailto:segreteriaministropisano@governo.it"
                          className="list-item mid-footer-link"
                          target="_blank"
                          rel="noreferrer"
                        >
                          segreteriaministropisano@governo.it
                        </a>
                      </li>
                    </ul>
                    <ul className="link-list">
                      ...
                      <li>
                        <a
                          href="mailto:comunicazione@innovazione.gov.it"
                          className="list-item mid-footer-link"
                          target="_blank"
                          rel="noreferrer"
                        >
            ...
            <div className="col-md-6 col-xl-3 mb-5">
              ...
              <div className="d-flex justify-content-center ml-3 d-md-block ml-md-0">
                <div className="d-flex align-items-center">
                  <a
                    href="https://twitter.com/InnovazioneGov"
              ...
              <div className="text-center text-md-left">
                <div className="link-list-wrapper">
                  <ul className="link-list">
                    <li>
                      <a
                        href="http://www.governo.it/"
                        className="list-item mid-footer-link"
                        target="_blank"
                        rel="noreferrer"
                        aria-label="Sito del Governo italiano: (Link esterno) Vai al sito del Governo"
                      >
                    ...
                    <li>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        aria-label="AgID - Agenzia per l'Italia Digitale: (Link esterno) Val al sito AgID"
                      >
                    ...
                    <li>
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        aria-label="PagoPA S.p.A.: (Link esterno) Vai al sito"
                      >
                        PagoPA S.p.A.
                      </a>
                    </li>
            ...
            <div className="col-md-6 col-xl-3 mb-3">
              ...
              <div className="text-center text-md-left">
                <div className="link-list-wrapper">
                  <ul className="link-list">
                    <li>
                      <a href="/amministrazione-trasparente" className="list-item mid-footer-link">
